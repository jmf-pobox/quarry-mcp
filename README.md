...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/ab576f0/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/ab576f0/install.sh -o install.sh
