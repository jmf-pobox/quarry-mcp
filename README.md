...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/950457a/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/950457a/install.sh -o install.sh
