...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/1c4c3c7/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/1c4c3c7/install.sh -o install.sh
