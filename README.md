...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/3e22cf7/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/3e22cf7/install.sh -o install.sh
