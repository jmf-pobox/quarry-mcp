...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/20a1941/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/20a1941/install.sh -o install.sh
...
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/20a1941/install.sh | sh -s -- --network
```
