...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/254bac5/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/254bac5/install.sh -o install.sh
