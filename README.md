...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/1e783cd/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/1e783cd/install.sh -o install.sh
