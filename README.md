...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/3d10f24/install.sh | sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/punt-labs/quarry/3d10f24/install.sh -o install.sh
