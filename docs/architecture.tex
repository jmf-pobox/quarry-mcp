...
\texttt{/search}      & GET & Vector-only search
  (\field{q}, \field{limit}, \field{collection}, \field{page\_type}, \field{source\_format}) & Yes \\
...
\texttt{install}              & Set up data directory, download model, configure ethos ext \\
