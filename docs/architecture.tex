...
and administration commands remaining local.  As of v1.12.4,
\texttt{find}, \texttt{show}, \texttt{status}, \texttt{ingest},
\texttt{remember}, \texttt{delete}, \texttt{sync}, and all
\texttt{list} subcommands route remotely.  Registration
create/delete and \texttt{use} are the remaining gaps.
...
As of v1.12.4, all data commands (\texttt{find}, \texttt{show},
\texttt{status}, \texttt{ingest}, \texttt{remember}, \texttt{delete},
\texttt{sync}, and all \texttt{list} subcommands) route remotely.
Registration create/delete and \texttt{use} remain local-only.
