...
\begin{tabular}{llll}
\hline
\textbf{Component} & \textbf{Hook Event} & \textbf{Files} & \textbf{Status} \\
\hline
Auto-register + sync & SessionStart & session-start.sh, session-sync.sh, hooks.py & Correct \\
Output formatting & PostToolUse (quarry) & suppress-output.sh & Correct \\
Web fetch capture & PostToolUse (WebFetch) & web-fetch.sh, hooks.py & Correct \\
Compaction capture & PreCompact & pre-compact.sh, hooks.py & Correct \\
\hline
\end{tabular}
