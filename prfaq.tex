...
\texttt{uv tool install punt-quarry} and \texttt{quarry install}. Point it at your
...
\begin{enumerate}[leftmargin=2em]
  \item \textbf{Install:} \texttt{uv tool install punt-quarry \&\& quarry install}
...
\begin{faqpair}{What is Quarry and who is it for?}
  ...
  for real work---writing, coding, research, analysis---and are
...
\begin{faqpair}{What is the total addressable market?}
  ...
  revenue exceeding \$2.5B. Claude Desktop adds to this base. Among
  these users,
...
\begin{faqpair}{Why now? What has changed?}
  ...
  is now supported by Claude Code and Claude Desktop. For the
...
\begin{faqpair}{Usability --- Can users figure out how to use it?}
  ...
  However, the product currently requires comfort with a
...
\begin{faqpair}{Feasibility --- Can we build it?}
  ...
  across 10 document formats with 737 passing tests and strict type checking.
