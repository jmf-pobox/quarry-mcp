...
\begin{faqpair}{What is the user acquisition strategy?}
  ...
  (\url{https://github.com/punt-labs/quarry-menubar}, in development) will
...
\begin{faqpair}{What is the development timeline and current status?}
  ...
  MCP server, CLI, HTTP API server.

  \textbf{In progress:} macOS menu bar companion app
  (\url{https://github.com/punt-labs/quarry-menubar}).
...
\begin{faqpair}{Feasibility --- Can we build it?}
  ...
  across 10 document formats with 596 passing tests and strict type checking.
